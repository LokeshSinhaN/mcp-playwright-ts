...
export interface WebSocketMessage {
  type: 'log' | 'error' | 'success' | 'action' | 'selector' | 'selenium' | 'thought' | 'action_taken' | 'progress' | 'warning' | 'action_success' | 'action_failed' | 'screenshot' | 'preview_ready' | 'browser_ready';
  timestamp: string;
  message: string;
  data?: unknown;
}
